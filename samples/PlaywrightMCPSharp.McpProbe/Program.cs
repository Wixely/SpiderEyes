    ...
    using var response = await SendRequestAsync(
        ...
        new JsonRpcRequest(
            ...
            Params: new
            {
                ...
                clientInfo = new
                {
                    name = "PlaywrightMCPSharp.McpProbe",
                    version = "1.0.0",
                },
            }));
...
static Uri GetEndpoint(string[] args)
{
    ...
    throw new ArgumentException("Usage: PlaywrightMCPSharp.McpProbe [--url <mcp-endpoint>] or PlaywrightMCPSharp.McpProbe [<mcp-endpoint>]");
}
